...
public class TryConnexion {
	...
	public static void closeConnection(TryConnexion tc) throws SQLException{
		tc.getConnection().close();
	}
	
	public static void afficheBlagues(TryConnexion tc) throws SQLException{
	...
	public static void afficheBlaguesParCateg(TryConnexion tc, String categ) throws SQLException{
		/* Ici, nous placerons nos requ̻tes vers la BDD */
	...
	public static Integer ajouteBlague(TryConnexion tc, String titre, String texte, String auteur, String categorie) throws SQLException{
		/* Ici, nous placerons nos requ̻tes vers la BDD */
		Integer categ =0;
		Integer i;
